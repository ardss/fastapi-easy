...
class TestTransactionRollback:
    ...
    async def test_manual_rollback(self, db_session_factory):
...
class TestTransactionEdgeCases:
    ...
    async def test_empty_transaction(self, db_session_factory):
    ...
    async def test_nested_transactions(self, transaction_adapter, db_session_factory):
        """Test nested transaction handling"""
        # Create outer transaction
        async with db_session_factory() as outer_session:
