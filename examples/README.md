...
**代码量**: ~150 行  
**复杂度**: ⭐ 极简  
**特点**: 完整的注释、清晰的结构、包含学习要点

---

### 第二层：数据库集成 (15 分钟)

**文件**: `02_with_database.py` ✅ 已创建  
**目标**: 连接真实数据库  
**学习内容**:
- ✅ 如何配置数据库连接
- ✅ 如何定义 ORM 模型
...
**代码量**: ~200 行  
**复杂度**: ⭐⭐ 简单  
**特点**: SQLite 数据库、完整的 CRUD、事务管理

---

### 第三层：查询功能 (20 分钟)

**文件**: `03_with_queries.py` ✅ 已创建  
**目标**: 添加搜索、过滤、排序、分页  
**学习内容**:
- ✅ 如何实现过滤功能
- ✅ 如何实现排序功能
...
**文件**: `04_advanced_features.py` ✅ 已创建  
**目标**: 添加软删除、权限、审计日志  
**学习内容**:
- ✅ 如何实现软删除
- ✅ 如何实现权限控制
...
**代码量**: ~300 行  
**复杂度**: ⭐⭐⭐⭐ 复杂  
**特点**: 软删除、RBAC 权限、审计日志、Hook 系统

---

### 第五层：完整项目 (1 小时)

**文件**: `05_complete_ecommerce.py` ✅ 已创建  
**目标**: 完整的电商 API  
**学习内容**:
- ✅ 多个资源的管理
- ✅ 资源之间的关系
